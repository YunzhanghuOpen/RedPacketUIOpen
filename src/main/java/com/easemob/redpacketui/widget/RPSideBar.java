...
public class RPSideBar extends View {
    ...
    public RPSideBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
    }

    public RPSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
     ...
     * 向外公开的方法
     *
     * @param onTouchingLetterChangedListener 触摸字母变化事件
     */
